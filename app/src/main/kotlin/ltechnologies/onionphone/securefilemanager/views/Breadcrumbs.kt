...
import ltechnologies.onionphone.securefilemanager.databinding.BreadcrumbItemBinding
import ltechnologies.onionphone.securefilemanager.extensions.getBasePath
...
class Breadcrumbs(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs),
    ...
    private fun addBreadcrumb(item: FileDirItem, addPrefix: Boolean) {
        val itemBinding = BreadcrumbItemBinding.inflate(
        ...
        itemBinding.root.apply {
            ...
            chip.text = textToAdd
            chip.setTextSize(TypedValue.COMPLEX_UNIT_PX, fontSize)
