...
import ltechnologies.onionphone.securefilemanager.helpers.RecyclerViewTuning
import ltechnologies.onionphone.securefilemanager.interfaces.MyActionModeCallback
...
abstract class RecyclerViewAdapter(
    ...
    private var actBarToolbar: MaterialToolbar? = null
    ...
    init {
        RecyclerViewTuning.apply(recyclerView)
        ...
        actModeCallback = object : MyActionModeCallback() {
            ...
            override fun onCreateActionMode(actionMode: ActionMode, menu: Menu?): Boolean {
                ...
                isSelectable = true
                actMode = actionMode
                actBarToolbar = View.inflate(activity, R.layout.actionbar_title, null) as MaterialToolbar
                actBarToolbar!!.layoutParams = ActionBar.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.MATCH_PARENT
                )
                actMode!!.customView = actBarToolbar
                actBarToolbar!!.setOnClickListener {
                ...
                activity.setFragmentActionModeActive(true)
                onActionModeCreated()
                return true
            }
            ...
            override fun onDestroyActionMode(actionMode: ActionMode) {
                ...
                activity.setFragmentActionModeActive(false)
